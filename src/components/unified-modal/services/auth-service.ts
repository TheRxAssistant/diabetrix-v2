import { clear as clearAuth, setPhoneNumber as setAuthPhoneNumber, setUser as setAuthUser, updateAccessToken, updateAuthToken } from '../../../store/authStore';
import { CAPABILITIES_API_URLS, CORE_ENGINE_API_URLS, postAPI } from '../../../services/api';
 ...
 */
export const verifyUserByVerified = async (phoneNumber: string, dateOfBirth?: string, ssn?: string): Promise<AuthResponse> => {
    try {
